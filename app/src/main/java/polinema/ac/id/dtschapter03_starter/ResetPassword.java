...
public class ResetPassword extends AppCompatActivity {
    ...
    public void postChangePassword(View view) {
        ...
        else if(editTextPassword.length()>=15 || editTextNewPassword.length()>15 || editTextConfirmPassword.length()>15) {
            Toast.makeText(view.getContext(), "Password melebih 15 karakter!", Toast.LENGTH_LONG).show();
        }
        ...
        else if(!editTextNewPassword.getText().toString().equals("") && !editTextConfirmPassword.getText().toString().equals("")
                && !editTextNewPassword.getText().toString().equals(editTextConfirmPassword.getText().toString())) {
